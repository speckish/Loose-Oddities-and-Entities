label start:
    ...
    scene living_room
    #note pan to the painting on the left 
    ...
    scene living_room
    #note zoom out into full image / Note: If possible, starting the zoom right before the pause and “I guess” would be nice.
