...
label peace:
    ...
    if len(dead_characters)>0:
        ...
        if with_cards:
            ...
            d "Okay. Thanks, mom."
            "She hangs up."
    if len(collected_monsters)==1:
        if "Horned" in collected_monsters:
