scene storage
#note on the left end + doll_chest
...
if office_explored:
    ...
    if orb_unwrapped:
        #note - is the orb being exposed a seperate conditon from having been in the office before? Should this be nested inside the office_explored if?
...
label wtf:
    ...
    scene storage
    #note zoom slightly into mannequin
    #note Expression:  Drew e, b, m
    ...
    scene storage
    #note zoom out and pan to the left, zoom into the chest
    if office_explored:
        ...
        scene storage
        #note zoom out and pan to the right
        mann "You should open that. "
        d "I “should”?"
        mann "Yes."
...
if not office_explored:
    ...
    label office_1:
        if office_explored and not orb_unwrapped:
...
label open_it:
    d "Okay, I'll do it."
    scene storage
    #note - pan to the left, zoom into the chest
...
label dont_grab_it:
    scene storage
    #note zoom out, Mannequin is closer
