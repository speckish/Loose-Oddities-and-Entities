...
scene: storage - zoom in to Mannequin
...
scene: storage - hide Close Up of Doll + pan to Mannequin+Doll
...
scene: storage - zoom in to mann Mannequin
...
scene: storage - zoom out
"Dead."
scene: storage - zoom in to chest
...
d "So…"
menu: 
Let them go. #let_them_go 
Dispose of them. #dispose_of_them
jump to #let_them_go
if killed someone else already
